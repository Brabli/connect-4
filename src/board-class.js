  ...
  scan(log = false) {
    ...
    for (let r = 0; r < 6; r++) {
      for (let c = 0; c < 3; c++) {
        ...
        rows.push( new Line(lineString, lineCoords, this.board) );
      }
    }
    // COLS
    for (let c = 0; c < 7; c++) {
      for (let r = 0; r < 2; r++) {
        ...
        cols.push( new Line(lineString, lineCoords, this.board) );
      }
    }
    // DIAGS BACK
    for (let r = 0; r < 2; r++) {
      for (let c = 0; c < 3; c++) {
        ...
        diags.push( new Line(lineString, lineCoords, this.board) );
      }
    }
    // DIAGS Front
    for (let r = 0; r < 2; r++) {
